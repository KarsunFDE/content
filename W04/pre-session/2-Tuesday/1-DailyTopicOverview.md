...
sources_research_briefs: [research/spring-boot-3-x-20260525.md]
author: instructor
---
...
- Reference brief: `research/spring-boot-3-x-20260525.md` (3.5.14 current + 2.7.18 OSS-EOL + `jakarta.*` migration vocabulary).
